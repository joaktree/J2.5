...
class JFormFieldPerson extends JFormField
{
	...
	function getInput()
	{
		...
		$linkTree   = 'index.php?option=com_joaktree&amp;view=jt_familytree&amp;layout=element&amp;task=element&amp;tmpl=component&amp;object='.$this->fieldname;
		$linkPerson = 'index.php?option=com_joaktree&amp;view=jt_admin&amp;layout=element&amp;task=element&amp;tmpl=component&amp;object='.$this->fieldname;
