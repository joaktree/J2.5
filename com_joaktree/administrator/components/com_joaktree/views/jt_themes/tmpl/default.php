...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th>
				<?php echo JHTML::_('grid.sort',  JText::_( 'JTTHEMES_HEADING_THEME' ), 'jtmp.name', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th width="5%">
				<?php echo JHtml::_('grid.sort', 'JTTHEMES_HEADING_DEFAULT', 'jtmp.home', $this->lists['order_Dir'], $this->lists['order']); ?>
			</th>
			<th width="2%">
	...
	?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td class="center">
				<?php echo JHtml::_('jgrid.isdefault', $row->home, $i, '', !$row->home);?>
			</td>
			<td class="center">
				<?php echo $row->id; ?>
			</td>
