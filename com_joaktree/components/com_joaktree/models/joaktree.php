...
class JoaktreeModelJoaktree extends JModel {
	...
	public function getOrderNumber() {
		if (!isset($this->_orderNumber)) {
			$tmp = JRequest::getInt('orderNumber', 0);
